...
function buildInboundCallScreeningInstructions(args: { style: InboundCallScreeningStyle }): string {
  ...
  return [
    ...
    '- BACKGROUND NOISE: Phone calls often have TV, other people, or ambient noise. Focus ONLY on the primary caller\'s voice. Ignore background speech that doesn\'t fit the conversation (TV dialogue, someone else in the room). Only respond to speech clearly directed at you. If unsure, ask: "Sorry, were you talking to me?"',
    '',
